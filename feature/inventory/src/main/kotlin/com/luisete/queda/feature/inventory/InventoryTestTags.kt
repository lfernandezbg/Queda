...
object InventoryTestTags {
    ...
    const val INVENTORY_TOP_BAR = "inventory_top_bar"
    ...
    const val INVENTORY_SCAN_BUTTON = "inventory_scan_button"
    ...
    const val ADD_EXACT_ITEM_DUPLICATE_BARCODE_ERROR = "add_exact_item_duplicate_barcode_error"
    ...
    // Barcode Scanner
    const val BARCODE_SCANNER_SCREEN = "barcode_scanner_screen"
    const val BARCODE_SCANNER_CLOSE_BUTTON = "barcode_scanner_close_button"
    const val BARCODE_SCANNER_PERMISSION_DENIED = "barcode_scanner_permission_denied"
    const val BARCODE_SCANNER_PERMISSION_RETRY_BUTTON = "barcode_scanner_permission_retry_button"
